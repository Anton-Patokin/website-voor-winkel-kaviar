    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                <img src="{{url('/image/carousel/1.jpg')}}" alt="{{trans('image_alt.carousel_1')}}">

            </div>

            <div class="item">
                <img src="{{url('/image/carousel/2.jpg')}}" alt="{{trans('image_alt.carousel_2')}}">
            </div>

            <div class="item">
                <img src="{{url('/image/carousel/3.jpg')}}" alt="{{trans('image_alt.carousel_3')}}">
            </div>
